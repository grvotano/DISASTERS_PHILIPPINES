...
data = pd.read_csv(full_path, parse_dates= ['start_date', ''], usecols= ('country_name', 'place_name', 'start_isodate',
...
date_time_obj = datetime.datetime.strptime(data['start_date'], '%Y-%m-%d %H:%M:%S.%f')
